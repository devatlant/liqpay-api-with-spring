...
public class LiqPayTest {
    ...
    static final String CNB_FORM_WITHOUT_SANDBOX = "<form method=\"post\" action=\"https://www.devatlant.ua/api/3/checkout\" accept-charset=\"utf-8\">\n" +
            ...
            "<input type=\"image\" src=\"//static.devatlant.ua/buttons/p1en.radius.png\" name=\"btn_text\" />\n" +
            "</form>\n";

    static final String CNB_FORM_WITH_SANDBOX = "<form method=\"post\" action=\"https://www.devatlant.ua/api/3/checkout\" accept-charset=\"utf-8\">\n" +
